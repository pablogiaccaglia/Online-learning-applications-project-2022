...
from Part3.GPTS_Learner_Vanilla import GPTS_LearnerVanilla
...
#comb_learner = CombWrapper(GTS_LearnerVanilla, 5, n_arms, daily_budget)
comb_learner = CombWrapper(GPTS_LearnerVanilla, 5, n_arms, daily_budget)
gts_rewards = []
